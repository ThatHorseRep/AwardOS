...
function SignInForm() {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      {error && (
        <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-2xl text-red-400 text-xs">
          {error}
        </div>
      )}
      ...
      <form action={handleSubmit} className="space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-zinc-900 border border-zinc-800 rounded-2xl text-white placeholder:text-zinc-500 text-xs focus:outline-none focus:border-blue-500 transition-all"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              required
              placeholder="••••••••"
              className="w-full px-4 py-2.5 bg-zinc-900 border border-zinc-800 rounded-2xl text-white placeholder:text-zinc-500 text-xs focus:outline-none focus:border-blue-500 transition-all pr-10"
            />
            <button
              type="button"
      ...
      <button
        ...
        type="button"
        className="w-full py-2.5 px-4 bg-white hover:bg-zinc-100 text-zinc-900 font-bold text-xs rounded-full transition-all duration-200 flex items-center justify-center gap-2"
      >
