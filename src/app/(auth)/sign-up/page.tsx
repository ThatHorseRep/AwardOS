...
import { signUpAction, enableDevBypassAction } from "@/actions/auth";
...
function SignUpForm() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error) {
        console.warn("Supabase Google OAuth fallback mode triggered:", error.message);
        await enableDevBypassAction();
      }
    } catch (err: any) {
      console.warn("Google Sign-In fallback mode triggered:", err?.message || err);
      await enableDevBypassAction();
    } finally {
