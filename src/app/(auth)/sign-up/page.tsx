      ...
      <form action={handleSubmit} className="space-y-2.5">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 bg-zinc-800/60 border border-zinc-700/60 rounded-xl text-white placeholder:text-zinc-500 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              required
              placeholder="••••••••"
              className="w-full px-3 py-2 bg-zinc-800/60 border border-zinc-700/60 rounded-xl text-white placeholder:text-zinc-500 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all pr-10"
            />
            <button
              type="button"
