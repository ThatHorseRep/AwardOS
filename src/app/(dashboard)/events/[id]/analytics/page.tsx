      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="border-slate-200/80 bg-white rounded-3xl shadow-sm">
          <CardContent className="pt-6">
            ...
            <div className="text-2xl font-extrabold text-slate-900 mt-1.5">{analytics.totalVotesCount}</div>
            <span className="text-[10px] text-slate-500 mt-1 block font-medium">Valid vote sessions cast</span>
          </CardContent>
        </Card>
